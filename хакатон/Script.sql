-- задача о 8 ферзях: SQL решение
-- расставить 8 ферзей на шахматной доске 8*8 так, чтобы они друг друга не поубивали
...
-- отсекаем позиции, в которых ферзи стоят на 1 строке
...
--сотсекаем позиции, в которых ферзи стоят на 1 диагонали
